...
import com.idat.laterraza.domain.exection.PhotoStorageException;
import com.idat.laterraza.domain.exection.MyPhotoNotFoundException;
    ...
    public Resource loadResource(String completeFileName) {
        ...
        try {
            ...
            if (resource.exists()) {
                ...
                throw new MyPhotoNotFoundException("Archivo no encontrado: " + completeFileName);
            }

        } catch (MalformedURLException e) {
            throw new MyPhotoNotFoundException("Ha ocurrido un error al intentar acceder al archivo: " + completeFileName, e);
        }
    }
}
